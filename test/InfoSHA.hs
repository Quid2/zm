...
codes = [TypeApp (TypeApp (TypeApp (TypeCon (AbsRef (SHA3_256_6 168 121 233 97 61 136))) (TypeCon (AbsRef (SHA3_256_6 10 197 162 77 118 54)))) (TypeCon (AbsRef (SHA3_256_6 10 197 162 77 118 54)))) (TypeApp (TypeCon (AbsRef (SHA3_256_6 122 206 49 124 168 130))) (TypeCon (AbsRef (SHA3_256_6 123 110 193 184 1 78))))
    ...
    ,Typ[![Stackage Nightly](http://stackage.org/package/model/badge/nightly)](http://stackage.org/nightly/package/model)
[![Stackage LTS](http://stackage.org/package/model/badge/lts)](http://stackage.org/lts/package/model)
eApp (TypeApp (TypeCon (AbsRef (SHA3_256_6 173 144 137 143 179 59))) (TypeCon (AbsRef (SHA3_256_6 129 212 40 48 111 29)))) (TypeCon (AbsRef (SHA3_256_6 129 212 40 48 111 29)))
